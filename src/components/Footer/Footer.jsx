    ...
    return (
        <div>
            <div class="bg-gray-100 ">
                <div class="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center pt-4">
                    <div class="p-5 w-48 ">
            ...
            <div class="bg-gray-100 pt-4 ">
                <div
                    class="flex justify-between pb-5 px-3 m-auto pt-5 border-t text-gray-800 text-sm 
                    ...
                    <div class="">
                        <div class="bg-white rounded-lg">
                            <div class="flex flex-wrap justify-between md:flex-row">
                                ...
                                />
                                <button class="w-full m-1 p-2 text-white text-sm bg-gray-800 rounded-lg font-semibold uppercase lg:w-auto">
                                    subscribe
                                </button>
                            </div>
                        </div>
